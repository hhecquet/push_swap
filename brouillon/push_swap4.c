...
int	push_swap(int *tab_a, int *tab_b)
{
	...
	{
		if (ft_strchr(tab_a, tab_b[0]) == 0 || ft_strchr(tab_a, tab_b[g_size_b(0,1) - 1]) == 0)
		{
			if (ft_strchr(tab_a, tab_b[g_size_b(0,1) - 1]) == 0)
				rrb(tab_b, g_size_b(0,1), 0);
			pa(tab_a, tab_b, g_size_a(0,1), g_size_b(0,1));
		}
		...
		{
			if (ft_strchr(tab_a, tab_b[g_size_b(0,1) -1]) < g_size_a(0,1)/2)
			{
				if((g_size_a(0,1) - ft_strchr(tab_a, tab_b[0])) < (1 + ft_strchr(tab_a, tab_b[g_size_b(0,1) -1])))
					while (ft_strchr(tab_a, tab_b[0]) != 0)
						rra(tab_a, g_size_a(0,1), 0);
				else if ((g_size_a(0,1) - ft_strchr(tab_a, tab_b[0])) >= (1 + ft_strchr(tab_a, tab_b[g_size_b(0,1) -1])) && (g_size_a(0,1) - ft_strchr(tab_a, tab_b[0])) > 0)
				{
					rrb(tab_b, g_size_b(0,1), 0);
					while (ft_strchr(tab_a, tab_b[g_size_b(0,1) -1]) != 0)
						ra(tab_a, g_size_a(0,1), 0);
				}
			}
			else
			{
				if((g_size_a(0,1) - ft_strchr(tab_a, tab_b[0]) ) < (1 + (g_size_a(0,1) - ft_strchr(tab_a, tab_b[g_size_b(0,1) -1]))))
					while (ft_strchr(tab_a, tab_b[0]) != 0)
						rra(tab_a, g_size_a(0,1), 0);
				else if ((g_size_a(0,1) - ft_strchr(tab_a, tab_b[0]) ) >= (1 + (g_size_a(0,1) - ft_strchr(tab_a, tab_b[g_size_b(0,1) -1]))) && (g_size_a(0,1) - ft_strchr(tab_a, tab_b[0]) ) > 0)
				{
		...
		else if (ft_strchr(tab_a, tab_b[0]) < g_size_a(0,1)/2)
		{
			if (ft_strchr(tab_a, tab_b[g_size_b(0,1) -1]) < g_size_a(0,1)/2)
			{
				if((ft_strchr(tab_a, tab_b[0]) ) < (1 + ft_strchr(tab_a, tab_b[g_size_b(0,1) -1])))
					while (ft_strchr(tab_a, tab_b[0]) != 0)
						ra(tab_a, g_size_a(0,1), 0);
				else if ((ft_strchr(tab_a, tab_b[0])) >= (1 + ft_strchr(tab_a, tab_b[g_size_b(0,1) -1])) && (ft_strchr(tab_a, tab_b[0])) > 0)
				{
					rrb(tab_b, g_size_b(0,1), 0);
					while (ft_strchr(tab_a, tab_b[g_size_b(0,1) -1]) != 0)
						ra(tab_a, g_size_a(0,1), 0);
			...
			{
				if((ft_strchr(tab_a, tab_b[0]) ) < (1 + 1 + (g_size_a(0,1) - ft_strchr(tab_a, tab_b[g_size_b(0,1) -1]))))
					while (ft_strchr(tab_a, tab_b[0]) != 0)
						ra(tab_a, g_size_a(0,1), 0);
				else if ((ft_strchr(tab_a, tab_b[0])) >= (1 + 1 + (g_size_a(0,1) - ft_strchr(tab_a, tab_b[g_size_b(0,1) -1]))) && (ft_strchr(tab_a, tab_b[0])) > 0)
				{
					rrr(tab_a, tab_b, g_size_a(0,1), g_size_b(0,1));
					while (ft_strchr(tab_a, tab_b[g_size_b(0,1) -1]) != 0)
						rra(tab_a, g_size_a(0,1), 0);
